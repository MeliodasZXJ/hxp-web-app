 ...
 * 融云相关
 */
public class RongCloudHttpUtil {
    ...
    private static HttpURLConnection CreatePostHttpConnection(String appKey,
        ...
        StringBuilder toSign = new StringBuilder(appSecret).append(nonce)
                .append(timestamp);
        String sign = RongCloudCodeUtil.hexSHA1(toSign.toString());
    ...
    public static RCloudSdkHttpResult returnResult(HttpURLConnection conn)
        ...
        return new RCloudSdkHttpResult(conn.getResponseCode(), result);
    }
