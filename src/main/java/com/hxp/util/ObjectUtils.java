...
public class ObjectUtils {
	...
	/**
	 * 可以用于判断变量是否为空
	 * @param o Object,String,StringBuffer,Collection,Map,Array
	 * @return 空返回真，否则返回假
	 */
	public static boolean isEmpty(Object o)  {
	    if (o == null) return true;
	    if (o.getClass().isArray() && Array.getLength(o) < 1) return true;
	    if (ClassUtils.isAssignable(o.getClass(), Collection.class)) return isEmpty((Collection<?>) o);
	    if (ClassUtils.isAssignable(o.getClass(), Map.class)) return isEmpty((Map<?, ?>) o);
	    if (o instanceof String) return isEmpty((String) o);
	    if (o instanceof StringBuffer) return isEmpty((StringBuffer) o);
	    return false;
	}
	...
	public static <T> boolean isBasicTypes(Class<T> clazz) {
		if (clazz.isPrimitive() || clazz.isEnum()
				|| clazz.equals(String.class) || clazz.equals(java.math.BigDecimal.class)
	...
	public static int indexOfArray(Object[] target, Object o) {
		if (isEmpty(target) || isEmpty(o)) return -1;
		for (int i = 0; i < target.length; i ++) {
			if (isEmpty(target[i])) continue;
			if (target[i].equals(o)) return i;
		}
		return -1;
	}
	...
	public static Object getObjectByBean(Object bean, String method, Object[] parameters, Class[] parameterTypes) throws Exception {
	...
	public static Object getObjectByBean(Object bean, String method, Object[] parameters, String[] parameterTypes) throws Exception {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static Object getObjectByClass(Class<?> clazz, String method, Object[] parameters, Class[] parameterTypes) throws Exception {
		if (parameters!=null && parameterTypes!=null && parameters.length==parameterTypes.length)
	...
	public static Object getObjectByClass(Class<?> clazz, String method, Object[] parameters, String[] parameterTypes) throws Exception {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static Object[] getArrayByBean(Object bean, String method, Object[] parameters, Class[] parameterTypes) throws Exception {
	...
	public static Object[] getArrayByBean(Object bean, String method, Object[] parameters, String[] parameterTypes) throws Exception {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static Object[] getArrayByClass(Class<?> clazz, String method, Object[] parameters, Class[] parameterTypes) throws Exception {
	...
	public static Object[] getArrayByClass(Class<?> clazz, String method, Object[] parameters, String[] parameterTypes) throws Exception {
