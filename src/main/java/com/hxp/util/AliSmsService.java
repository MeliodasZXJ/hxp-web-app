...
public class AliSmsService {
	...
	public static void main(String[] args) throws Exception {
		...
		String activeCode = getActivatingKey(6);
	...
	public static boolean sendSmsMessage(String mobile, String message) {
		boolean result = false;
		try {
			// 使用阿里大鱼短信通道发信息
			AliSmsService.sendSms(mobile, message, smsTempId);
			result = true;
		} catch (Exception e) {
			result = false;
		}
	 ...
	 */
	public static boolean sendRegCodeMobile(String mobile, String activeCode) throws Exception {
		// 发送验证码
		// String message = new
		// StringBuffer("好心情医疗平台验证码为：").append(activeCode).append("，请及时使用此验证码。如非本人操作，请忽略此短信。【好心情医疗平台】").toString();
