...
public class ImageUtils {
    ...
    public static void scale(String srcImageFile, String result,
                             int scale, boolean flag,float alpha) {
        try {
    ...
    public final static void scale2(String srcImageFile, String result, int height, int width, boolean bb) {
        try {
            ...
            BufferedImage bi = ImageIO.read(f);
            BufferedImage itemp = new BufferedImage(width, height, bi.SCALE_SMOOTH);
            // 计算比例
            if ((bi.getHeight() > height) || (bi.getWidth() > width)) {
                if (bi.getHeight() > bi.getWidth()) {
...
//                g.setColor(Color.white);
            ...
            ImageIO.write(itemp, "jpg", new File(result));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
//    public static void main(String[] args) throws IOException {
//    	pressImage("C:/Users/jyd/Desktop/xx/xxx/2.jpg", "C:/Users/jyd/Desktop/xx/xxx/ad00111.jpg", -1, -1,1f);
//        pressImage("C://pic//jpg", "C://pic//test.gif", 5000, 5000, 0f);
//        pressText("C://pic//jpg", "旺仔之印", "宋体", Font.BOLD|Font.ITALIC, 20, Color.BLACK, 0, 0, 8f);
//    	scale("C:/Users/jyd/Desktop/xx/ad00111.jpg","C:/Users/jyd/Desktop/xx/ad00113.jpg", 2, true,0);
//    	scale2("C:/Users/jyd/Desktop/xx/ad00111.jpg","C:/Users/jyd/Desktop/xx/ad00112.jpg", 1300, 1000, true);
//    }
}
