...
<script src="${ctx}/assets/js/feedBack/doctor_feed_back_list.js"
	...
	<div class="wrapper wrapper-content animated fadeIn">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<div class="row">
					<div class="col-md-12">
						<div class="btn-group hidden-xs" id="doctorFbListTableToolbar"
							role="group">
						...
						<table id="doctorFbListTable" data-mobile-responsive="true">
						</table>
					</div>
				</div>
			</div>
